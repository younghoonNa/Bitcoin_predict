...
def upbit_coin_image():
    ...
    imgGrab = ImageGrab.grab(bbox=(string[0], string[1]-35, string[2]-15, string[3]- 35))
    sub_Big_img = cv2.cvtColor(np.array(imgGrab), cv2.COLOR_RGB2BGR)

    return Big_img, sub_Big_img

def bithumb_title_image():
    ...
    imgGrab = ImageGrab.grab(bbox=(string[0]+30, string[1], string[0]+120, string[1] + 35))
    image_title = cv2.cvtColor(np.array(imgGrab), cv2.COLOR_RGB2GRAY)
...
def bithumb_coin_image():
    ...
    imgGrab = ImageGrab.grab(bbox=(string[0]+35, string[1]+35, string[2], string[3]))
    image_title = cv2.cvtColor(np.array(imgGrab), cv2.COLOR_RGB2BGR)

    imgGrab = ImageGrab.grab(bbox=(string[0], string[1]-35, string[0]+100, string[1]-5))
    sub_image_title = cv2.cvtColor(np.array(imgGrab), cv2.COLOR_RGB2BGR)
